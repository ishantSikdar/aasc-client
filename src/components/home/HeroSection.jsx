	...
	return (
		...
		>
			...
			<div className="z-10">
				...
				<h1 className="uppercase font-bold text-3xl md:text-5xl lg:text-7xl my-2 md:my-3">Alumni Association</h1>
				<p className="text-sm md:text-xl leading-5 mx-5 lg:mx-40">
