...
export default function AascCouncilPage({ isMobile }) {
    return <div className="my-20 flex flex-col gap-10 md:px-10 xl:px-52">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-10 md:gap-16 justify-center items-center  xl:items-end">
